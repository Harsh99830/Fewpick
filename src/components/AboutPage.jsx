...
import { ArrowRight, Bike, Clock3, Heart, MapPin, ShieldCheck, ShoppingBag, ShoppingBasket, Smartphone, PackageCheck } from 'lucide-react';
...
const features = [
  { icon: ShoppingBasket, tone: 'blue', title: 'No Minimum Order', copy: <>Order even if you need<br />just one item.<br />No minimum order.</> },
...
const steps = [
  ...
  { number: '03', tone: 'purple', title: 'We deliver it', copy: <>Your order gets delivered<br />within 1 km for a flat ₹10<br />rider’s effort.</>, graphic: 'scooter' },
];

function Wordmark() { return <div className="ap-wordmark"><span>few</span><b>pick</b></div>; }
